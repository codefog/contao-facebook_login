facebook_login Contao Extension
===============================

Allow the users to log in with their Facebook accounts. Please note that you need to create a Facebook app to make this extension work!
